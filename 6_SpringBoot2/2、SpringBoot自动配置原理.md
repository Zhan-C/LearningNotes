...
- - <font color=red>主程序所在包及其下面的所有子包里面的组件都会被默认扫描进来</font>
  ...
  - 想要改变扫描路径，@SpringBootApplication(scanBasePackages=**"com.zhanc"**)
...
- ### @ComponentScan、@Import<font color=red>（默认组件的名字就是全类名）</font>
...
- ### @EnableAutoConfiguration<font color=red>(重点注解)</font>
